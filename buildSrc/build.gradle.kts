...
dependencies {
    ...
    implementation("org.jetbrains.kotlin:kotlin-compose-compiler-plugin:$kotlinVer")

    implementation("org.jetbrains.kotlin.plugin.compose:org.jetbrains.kotlin.plugin.compose.gradle.plugin:$kotlinVer")
