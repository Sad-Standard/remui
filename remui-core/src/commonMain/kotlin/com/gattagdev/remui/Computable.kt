...
@Serializable
@Polymorphic
data class DynamicValue @PublishedApi internal constructor(val type: @Contextual KType, val value: @Contextual Any?)
...
data class Computable<out T> constructor(@PublishedApi internal val internal: Internal) {
    ...
    @PublishedApi
    @SerialName("c")
    internal data class Const(val given: DynamicValue): Internal{
        context(ComputableContext)
...
inline val <reified T> T.rc: Computable<T> get() = Computable<T>(makeConst(this))

    @PublishedApi
internal inline fun <reified T> makeConst(value: T): Computable.Internal = Computable.Const(dynamic(value))
...
inline operator fun <reified C: CFunction1<R, P0>, R, P0> C.invoke(p0: Computable<P0>): Computable<R> = Computable(Computable.FunctionCall(makeConst(this as CFunction<Nothing>), listOf(p0.internal)))
...
inline operator fun <reified C: CFunction2<R, P0, P1>, R, P0, P1> C.invoke(p0: Computable<P0>, p1: Computable<P1>): Computable<R> = Computable(Computable.FunctionCall(makeConst(this as CFunction<Nothing>), listOf(p0.internal, p1.internal)))
...
inline operator fun <reified C: CFunction3<R, P0, P1, P2>, R, P0, P1, P2> C.invoke(p0: Computable<P0>, p1: Computable<P1>, p2: Computable<P2>): Computable<R> = Computable(Computable.FunctionCall(makeConst(this as CFunction<Nothing>), listOf(p0.internal, p1.internal, p2.internal)))
...
fun <T> Computable<Computable<T>>.unwrap() = Computable<T>(Computable.Use(this.internal))
